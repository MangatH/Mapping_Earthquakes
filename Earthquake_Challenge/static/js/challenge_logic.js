...
// We create the third tile layer thal will be the background of our map.
...
// Add 3 layer groups for the earthquake, tectonic plate and major earthquakes data.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // Then we add the earthquake, tectonic plates and major earthquake layer to our map.
  allEarthquakes.addTo(map);
  tectonicPlates.addTo(map);

// Retrieve the major earthquake GeoJSON data >4.5 mag for the week.
let maj_EQ = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson";
